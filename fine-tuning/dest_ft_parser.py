"""
This script is used to format the training data for the destination parameters function to the format supported by OpenAI.
"""
...
if __name__ == "__main__":
    ...
    with open("../data/dest_training_data.jsonl", "w") as file:
        for example in training_data:
            file.write(json.dumps(example) + '\n')
            
    print("Training data generated and saved to dest_training_data.jsonl.")
